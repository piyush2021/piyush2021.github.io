<template>
  <q-page class="flex content-center justify-center abt-page q-py-md q-px-xl">
    <div class="content text-center" :class="$q.dark.isActive ? 'bg-primary' : ''">
      <h4 class="full-width text-accent text-bold q-mt-sm q-mb-lg">About Piyush</h4>
      Piyush Bhatia is a <i>fun loving, jovial, techinically sound, highly ambitious and very friendly</i> person.
